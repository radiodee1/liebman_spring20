...
Significant but not shown is that other words, like `what' and `your', do not have strong attention to other words in the text. In a chart like this one they would show no colors on the right and no lines connecting the left to the right.
...
During inference the Scaled Dot Product Attention in the GPT2 focuses on certain words as it processes input text. Here the word `favorite' shows a relationship to many of the other words in the text. Curiously it does not relate strongly to the word `color'. 
