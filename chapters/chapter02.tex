...
\begin{figure}[H]
	...
	\end{center}
	\caption[Encoder Flow Detail]{Encoder Flow Details - encoder attention.}
...
\begin{figure}[H]
	\begin{center}
		...
		\includegraphics[scale=0.75]{diagram-graph-decoder-flow-b}
	\end{center}
	\caption[Decoder Flow Detail]{Decoder Flow Details for encoder-decoder attention.}
