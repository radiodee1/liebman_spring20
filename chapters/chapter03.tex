...
On the Jetson Nano the largest model, the 117 M GPT2 model, takes a few seconds to execute. The other models are smaller than the GPT2 model, and so all would take less than two seconds.
