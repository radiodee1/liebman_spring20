...
In a transformer classifier we might choose 125 sentences for the maximum number of classifications. If we were going to try to create a chatbot that was trained for a specific Q/A task using a transformer this might be important. We could use 125 as our maximum number of outputs. 

We do not experiment with classifiers, but we mentioned BERT, which can be configured as a classifier.
