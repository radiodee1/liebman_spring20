...
The Nano that the GPT2 model was installed on was outfitted with a speaker, a microphone, and a wifi dongle. Pytorch for the Nano is installed from a community web site where version 1.5 was already cross compiled for the aarch64 environment. Execution of a single response from the model took two or three seconds.
