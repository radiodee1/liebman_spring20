...
Below is text that shows a formula for the product of conditional probabilities. It says that the $s_n$ term relies on the sequence of terms that starts with $s_1$ and continues to $s_{n-1}$.
