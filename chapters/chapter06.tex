...
While the GPT2 model is very large and very versatile, the Transformer and GRU models are smaller. In Figure \ref{diagram-words-limit-shown}, 10,000 inputs from the training set of the movie dialog corpus were used. 
