...
In these discussions we use the fully trained GRU and Transformer models. They are setup in inference mode and their output is observed when they are exposed to the first 2000 training inputs from the Movie Subtitles corpus.
...
\subsection{Transformer and GRU - Training Progress}
