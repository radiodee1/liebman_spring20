...
Response time with the Nano was reduced to just a few seconds. Response time on the Raspberry Pi for the 117M model was closer to 15 seconds. See the discussion of `Reply Time' in Section \ref{setup-reply-time}.
