...
The GRU coding experiment is considered unsuccessful. For Raspberry Pi installation we use the GRU tutorial. See Section \ref{chatbot-gru-tutorial-used} for a discussion of the Raspberry Pi installation. % from Inkawhich. % et al \cite{2018Inkawhich}.
