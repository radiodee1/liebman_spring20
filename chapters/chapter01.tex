...
Our task is to train a Neural Network to translate a given input corpus. It is generally felt that the corpus should be divided into three parts. The largest part, maybe \%80 is held for training. Then \%10 should go to what is called `validation' and \%10 should go to `testing'.
...
This is useful for tuning hyper-parameters, which are parameters that occur in the model. Repeatedly you train, and as you do you asses at the validation scores for clues on what to change in your hyper-parameters. 
